...
#for showing signup/login button for teacher(by Mubhin)
...
#for showing signup/login button for student(by Mubhin)
...
#for checking user is techer , student or admin(by Mubhin)
def is_admin(user):
...
#for dashboard of adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Mubhin)
...
def admin_dashboard_view(request):
    ...
    #aggregate function return dictionary so fetch data from dictionay(by Mubhin)
    mydict={
...
#for teacher sectionnnnnnnn by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Mubhin)
...
#for student by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Mubhin)
...
#attendance related viewwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwwww(by Mubhin)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
#fee related view by adminnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnnn(by Mubhin)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
#notice related viewsssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss(by Mubhin)
@login_required(login_url='adminlogin')
@user_passes_test(is_admin)
...
#for TEACHER  LOGIN    SECTIONNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNNN(by Mubhin)
...
#FOR STUDENT AFTER THEIR Loginnnnnnnnnnnnnnnnnnnnn(by Mubhin)
...
# for aboutus and contact ussssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssssss (by Mubhin)
